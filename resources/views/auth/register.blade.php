                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 row">
                                <label for="user_email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail') }}
                                    <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-4 row">
                                <label for="restaurant_email" class="col-md-4 col-form-label text-md-right">Indirizzo mail
                                    Ristorante
                                    <span class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="email"
                            ...
                            <div class="mb-4 row">
                                <label for="types" class="col-md-4 col-form-label text-md-right">Tipologia <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6 d-flex gap-2 justify-content-center flex-wrap ">
