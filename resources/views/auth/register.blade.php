                ...
                <div class="col-md-8 pb-5">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="text-center text-white">Registrati</h3>
                            <form onsubmit="return validateForm()" method="POST" action="{{ route('register') }}"
                            enctype="multipart/form-data">
                            @csrf
                            {{-- User Form --}}
                            
                            <h2 class="text-center text-white">Dati Utente</h2>
                            <br>
                            <div class="mb-4 m-auto w-75">
                                <label for="user_name" class="col-md-4 col-form-label text-white text-md-right">{{ __('Nome') }}
                            ...
                            <div class="mb-4 m-auto w-75">
                                <label for="lastname" class="col-md-4 col-form-label text-white text-md-right">{{ __('Cognome') }}
                                ...
                                <div class="mb-4 m-auto w-75">
                                    ...
                                    class="col-md-4 col-form-label text-white text-md-right">{{ __('E-Mail') }}
                                    <span class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-4 m-auto w-75">
                                        <label for="password"
                                        class="col-md-4 col-form-label text-white text-md-right">{{ __('Password') }}
                                        <span class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-4 m-auto w-75">
                                        ...
                                        class="col-md-4 col-form-label text-white text-md-right">{{ __('Conferma Password') }} <span
                                    ...
                                    <br>
                                    <h2 class="text-center text-white">Dati Ristorante</h2>
                                    <br>
                                ...
                                <div class="mb-4 m-auto w-75">
                                    <label for="restaurant_name" class="col-md-4 col-form-label text-white text-md-right">Nome
                                ...
                                <div class="mb-4 m-auto w-75">
                                    <label for="address" class="col-md-4 col-form-label text-white text-md-right">Indirizzo <span
                                        class="text-danger">*</span></label>
                                    <div class="">
                                        <input type="text" required
                                ...
                                <div class="mb-4 m-auto w-75">
                                    <label for="phone_number" class="col-md-4 col-form-label text-white text-md-right">Numero di
                                        telefono</label>
                                        <div class="">
                                            <input type="tel"
                                    ...
                                    <div class="mb-4 m-auto w-75">
                                        <label for="p_iva" class="col-md-4 col-form-label text-white text-md-right">Partita IVA <span
                                            class="text-danger">*</span></label>
                                            <div class="">
                                        ...
                                        {{-- Types input --}}
                                        <div class="mb-4 m-auto w-75">
                                            <label for="types" class="col-md-4 col-form-label text-white text-md-right">Tipologia <span
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="col-md-6 d-flex gap-2 flex-wrap w-100">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label text-white" for="type-{{ $type->id }}">
                                                            {{ $type->name }}
                                                        </label>
                                                </div>
                                            @endforeach
                                ...
                                {{-- Image input --}}
                                <div class="mb-4 m-auto w-75">
                                    <label for="image" class="col-md-4 col-form-label text-white text-md-right">Immagine <span
                                        class="text-danger">*</span></label>
                                        <div class="">
                                    ...
                                    <div style="width: 616px" class="m-auto py-3 text-white">
